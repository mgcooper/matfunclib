...
% mgc: objectType is listed abvoe the call to parseInputs - its the type of
% plotting object. alt is literally altitude, not a variable, b/c it uses the
% ellipsoid to transform (i think). other than the possiblity that 'UserData'
% field could be used, i don't think therre's a backdoor way tto get projected
% raster data out of this
