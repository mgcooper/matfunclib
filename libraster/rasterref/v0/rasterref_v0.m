function R = rasterref_v0(X,Y,rasterInterpretation)

% this is the working version prior to enforcing rasterInterpretation
...
switch nargin
    case 2
        ...
        disp(['No rasterInterpretation given, type ''Postings'' was assumed. ' ...
        newline 'For image-based data specify ''Cells''. For climate ' ...
        'model data ''Postings'' is correct. ' newline ...
        'Use related function ''Rpost2cells'' to convert an R object ' ...
        'from postings to cells.']);
    case 3
        assert(strcmp(rasterInterpretation,'cells') | ...
        strcmp(rasterInterpretation,'postings'), ...
        ['Input argument 3, rasterInterpretation, must be ', ...
        'either "cells" or "postings"']);    
end
