function R = rasterref_test(X,Y,cellInterpretation)

%RASTERREF R = rasterref(X,Y,cellInterpretation) constructs spatial
%referencing object R from 1-d vectors or 2-d grids X,Y that define the E-W
%and N-S coordinates of each grid cell center
%(cellInterpretation='Postings') or each grid cell N-W edge
...
%   X:  x-coordinate of points/cell edges. Can be 1-d or 2-d.
%   Y:  y-coordinate of points/cell edges. Can be 1-d or 2-d.

%   LON: longitude coordinates of points/cell edges. Can be 1-d or 2-d.
%   LAT: latitude-coordinates of points/cell edges. Can be 1-d or 2-d.

%   cellInterpretation (optional):
%   1. 'postings': the x/y | lon/lat coords geolocate the grid cell centers
%   2. 'cells': the x/y | lon/lat coordinates geolocate the grid cell edges

%   See detailed description below if this doesn't make sense
