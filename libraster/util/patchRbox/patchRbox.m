function [h, coords] = patchRbox(R, varargin)
%PATCHRBOX plot a patch over the map/geographic raster reference object R limits
%
% [h, coords] = patchRbox(R) plots a box as a patch corresponding to the
% geographic limits of the map/geographic raster reference object R into the
% default axes.
%
% [h, coords] = patchRbox(R, ax) plots a box corresponding to the geographic
% limits of the map/geographic raster reference object R into the provided axes.
%
%   Author: Matt Cooper, guycooper@ucla.edu, May 2019
%   Citation: Matthew Cooper (2019). matrasterlib
%   (https://www.github.com/mguycooper/matrasterlib), GitHub. Retrieved MMM DD, YYYY
%
% See also plotRbox
...
%% apply the appropriate function
   ...
   h           =   patch(ax,'XData',coords.x,'YData',coords.y,varargin{:});
   end
