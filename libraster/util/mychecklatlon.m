% copied from built in function, not sure if this is new, but i saw it in
% areaint, i can compare to the checks i currently perform, and make my own
% functon to reduce the raster functions down a bit

function mychecklatlon(lat, lon, func_name, ...
