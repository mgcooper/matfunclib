...
%
% [h, coords] = plotRbox(R) plots a box corresponding to the geographic limits
% of the map/geographic raster reference object R into the default axes.
%
...
%   (https://www.github.com/mguycooper/matrasterlib), GitHub. Retrieved MMM DD,
%   YYYY
%
