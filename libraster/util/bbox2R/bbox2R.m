...
%
% R = bbox2R(bbox,grid_res) constructs spatial referencing object R from 2-by-2
% bounding box bbox, for example as provided by mapbbox. The cell spacing set by
% gridRes must be constant. If necessary, maprefcells adjusts the limits of the
% raster slightly to ensure an integer number of cells in each dimension.
%
...
validateattributes(bbox, {'numeric'}, {'2d','size',[2,2]}, 'bbox2R', 'bbox', 1)
validateattributes(gridRes, {'numeric'}, {'scalar'}, 'bbox2R', 'gridRes', 2)
