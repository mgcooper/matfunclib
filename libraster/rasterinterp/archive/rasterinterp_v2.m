...
% and planar inputs, check that R and Rq are same projection
...
projR1 = R.CoordinateSystemType;
projR2 = Rq.CoordinateSystemType;

assert(strcmp(projR1,projR2),['R and Rq must both be planar or both be ' ...
        'geographic coordinate systems. Re-projection on the fly is ' ...
        'not supported at this time']);
    
assert(strcmp(projR1,projR2),['It appears R or Rq defines a geographic ' ...
    'coordinated system ]);    
