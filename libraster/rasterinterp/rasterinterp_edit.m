...
% NOTE need to update with postings objects based on what I learned in
% rasterref
...
% IN PROGRESS - note I found a way to go from cells to postings using the
% hidden property R.worldFileMatrix. Turns out this also resolves the error
% I found in the raster extent using postings vs cells

% confirm R and Rq are either both of type 'Cells' or both 'Postings'
assert(strcmp(class(R),class(Rq), ...
                        ['R and Rq must both be of same class. Valid ' ...
                        'types include ]);
% IN PROGRESS END
