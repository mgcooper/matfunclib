...
%R as 2-d contours with labels using in-built Matlab functions mapshow.m or
%geoshow.m. Default behavior sets properties ('DisplayType','contour'),
%('ShowText','on'), ('Box','on'), ('TickDir','out'), ('LineWidth',1.5),
%axis image, and adds a colorbar. The function accepts any input to
%mapshow.m or geoshow.m and returns the graphics, axis, and colorbar handle
%objects so the user can make ex-post adjustments as desired.
