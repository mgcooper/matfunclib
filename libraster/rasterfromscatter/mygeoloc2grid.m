function [Z, R, refvec] = mygeoloc2grid(lat, lon, A, cellsize, interpmethod, extrapmethod) % mgc added 'R' and 'method'
...
F = scatteredInterpolant(lon(:), lat(:), A(:),interpmethod,extrapmethod); % mgc added 'method'
