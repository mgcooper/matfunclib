...
% 
%  setupfile() adds the path from which this file is run and all subdirectories
%  to the userpath, ignoring ones that start with '.' (including .git, .svn,
%  etc.), runs files in the userhooks/ directory if one exists, and sets default
...
% 
%  setupfile(PROJECTNAME, PROJECTPATH) adds the specified PROJECTPATH instead of
%  the one from which this file is run to the user path.
% 
...
%  directory in which this file is saved. For example, if this file is saved in:
%  /Users/truelegend/projects/super/setupfile.m
%  then PROJECTNAME='super' and PROJECTPATH='/Users/truelegend/projects/super'
% 
...
% Turn off warnings. Default behavior turns off warning about paths not already
% being on the path when removed.
...
% This is true if running in desktop. Use it to suppress interactions with the
% editor or any other feature that requires the Matlab desktop application.
if usejava('desktop')
   % user hooks related to the editor go here, such as opening or closing files
end
