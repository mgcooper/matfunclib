classdef ParameterizedTestTbx < matlab.unittest.TestCase
   ...
   methods (Test)
      ...
      %-------------------------------------------
      %-------------------------------------------
      function test_getdqdt(testCase, MethodName)

      % import the test data
      [x,~,t] = tbx.test.generateTestData();
      ...
      %-------------------------------------------
      %-------------------------------------------
      function test_fitab(testCase, ParameterValue, MethodName)
      ...
      %-------------------------------------------
      %-------------------------------------------
      function test_aquiferstorage(testCase, ParameterValue)
