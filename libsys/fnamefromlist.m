function fname = fnamefromlist(filelist, varargin)
   %FNAMEFROMLIST Convert list returned by dir to full-path filename list
   %
   ...
   %
   %  fname = fnamefromlist(_, 'asstring') Returns a list formatted as an
   %  array of strings. Default behavior is to return a cellstr array of chars.
   %
   ...
   %
   % Updates
   % 23 Jan 2023 - removed filepath input, now uses filelist.folder, combined
   % with list2path and deleted list2path function
