function [ list ] = getlist( dirpath, pattern, varargin )
   ...
   % NOTE: 'pattern' is a function designed to match text patterns ... not sure
   % if my use here conflicts with that but when I tried to call this function
   % from getfilelist which used 'pattern' as an optional input the input parser
   % here interpreted pattern as the output of the function 'pattern'
