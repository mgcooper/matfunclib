function S = flattenstruct(S, delim)
   %FLATTENSTRUCT Convert a struct with substructs to a single-level struct.
   %
   %   All fields in S of type struct will be removed and their fields added to
   %   the parent struct, S. The new field names will be
   %   "fieldname_subfieldname". This process is recursive.
   %
   %   Example:
   %   S.field1 = "parent";
   ...
   %   delim   delimiter to use between subtructure and subfield name. 
   %           Default is '_'.
   %
   %   Output:
