function ignorepaths = octaveignorepaths()
   ...
   ignorepaths = {
      ...
      fullfile(getenv('MATLAB_FUNCTION_PATH'), 'libcells', 'vec'); ...
      fullfile(getenv('MATLAB_FUNCTION_PATH'), 'liboctave', 'fdisp'); ...
      fullfile(getenv('MATLAB_FUNCTION_PATH'), 'libstats', 'stderr'); ...
