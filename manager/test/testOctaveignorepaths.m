classdef testOctaveignorepaths < matlab.unittest.TestCase
   ...
   methods (Test)
      function testListDerivesFromBothEnvVars(testCase)
         % The list holds seven MATLAB_FUNCTION_PATH entries and the one
         ...
         expected = {
            ...
            fullfile(tempdir, 'funclib', 'libcells', 'vec'); ...
            fullfile(tempdir, 'funclib', 'liboctave', 'fdisp'); ...
            fullfile(tempdir, 'funclib', 'libstats', 'stderr'); ...
