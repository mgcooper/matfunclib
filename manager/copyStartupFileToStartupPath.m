...
% 
% Copy a version of startup.m under source control in a user-defined env folder 
% returned by getenv('MATLABFUNCTIONPATH') to the startup folder defined by
% the 'userpath' function.
