function filelist = checkFunctionConflicts(varargin)
%checkFunctionConflicts find duplicate function names
% 
% Syntax
% 
%  filelist = checkFunctionConflicts(funcname) returns a filelist in the format
...
% 
%  filelist = checkFunctionConflicts('library',funclibrary) returns a list of
...
%------------------------------------------------------------------------------
p                 = magicParser;
p.FunctionName    = 'checkFunctionConflicts';
