...
%  variables. When METHOD is 'system', a call to system('set') is used if ispc()
%  returns TRUE, otherwise a call to system('env') is used (e.g., on macos).
%  When METHOD is 'java', a call to java.lang.System.getenv() is used. Default
%  METHOD is 'system'.
%
% % Example
