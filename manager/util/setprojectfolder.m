function varargout = setprojectfolder(projectname,projectfolder,projectlist)
   ...
   %     associated with 'E3SM-MOSART-offline-mode' b/c the code for 'interface'
   %     is actually in 'E3SM-MOSART-offline-mode' folder:
   %
   ...
   % the second argument is a backdoor way to get the path quickly for any
   % project
