...
% Note this is not called by any functions. If it is later added, pay attention
% to how the activefiles are updated. The main purpose is to link the
% activefolder so the desired folder is activated with workon, not to override
% the active files
