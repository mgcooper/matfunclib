function location = getDefaultScreenLocation(w)
   %GETDEFAULTSCREENLOCATION Get the default screen location
   %
   %  location = getDefaultScreenLocation()
   %  location = getDefaultScreenLocation(screenwidth)
   %
   % See also: figposition
