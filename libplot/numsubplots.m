function [p, n]=numsubplots(n)
   %NUMSUBPLOTS compute the number of subplot rows and columns for given total N
   %
   %  [n, m] = numsubplots(N)
   %
   % Purpose
   ...
   % Reformat if the column/row ratio is too large: want a roughly square design
   while p(2)/p(1)>2.5
      N=n+1;
