function h = figformat(varargin)
   ...
   % this will copy the 'suppliedaxis' to gcf, which may not be the one you want
...
function ff = refigformat(arg1,arg2)
   ...
   % parse input
   if isstruct(arg1)
      % assume it's the figformat handle struct
      ff  = arg1;
      cmd = arg2;
   elseif ischar(arg1)
...
%% mgc: this is in the mapping toolbox, but could be helpful for figformat
