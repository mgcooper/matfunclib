classdef ScatterFitClass < matlab.ui.componentcontainer.ComponentContainer
   %SCATTERFIT Chart component managing 2D scattered data (x and y)
   %together with the corresponding best-fit line.
   %
   % Copyright 2018-2022 The MathWorks, Inc.

   % mgc renamed ScatterFitClass temporarily b/c i have scatterfit function
   ...
   methods ( Access = protected )
      ...
      % mgc: Cog.png doesn't seem to exist 
