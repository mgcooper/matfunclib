...
%  values in cell- or string-array VARNAMES. In this syntax, there must be one
%  value in VARNAMES for each column of T.
% 
%  T = settablevarnames(T, VARNAME, 'consecutive') sets all variable names in
%  table T to VARNAME with the column number appended. In this mode, VARNAME can
%  be a scalar string, cell array, or a char array, and the column number is
%  appended such that the variable names of T are VARNAME_1, VARNAME_2, ...,
%  VARNAME_N.
% 
% See also
