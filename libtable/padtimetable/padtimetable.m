...
%   Inputs:     T          =   timetable of monotonically increasing data
...
%~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~   
   ...
   validT  = @(x)validateattributes(x,{'timetable'},{'nonempty'},       ...
               'padtimetable','T',1);
   validt1 = @(x)validateattributes(x,{'datetime'},{'nonempty'},        ...
               'padtimetable','t1');
   validt2 = @(x)validateattributes(x,{'datetime'},{'nonempty'},        ...
               'padtimetable','t2');
   validdt = @(x)validateattributes(x,{'duration'},{'nonempty'},        ...
               'padtimetable','dt');
