function [pet, Rn, vpd, G, Rs] = PET_fao_pm(tmax, tmin, tdmean, lat, alt, coast, years)
%PET_fao_pm Calculate potential evapotranspiration of reference crop using FAO
% Penman-Monteith method (Allen et al. 1998) 
% 
% [pet, Rn, vpd, G, Rs] = PET_fao_pm(tmax, tmin, tdmean, lat, alt, coast, years)
% Calculates the FAO version of Penman-Monteith potential evapotranspiration 
% Based on Allen et al. 1998, "Crop Evapotranspiration: Guidelines for Computing
% Crop Water Requirements", Ch. 2-4. 
% 
% Inputs:
% 
