...
% dryrun=true resolves and prints the file list without downloading;
% set dryrun=false to actually install into installPath. (This call's old
% installMissing argument was real but renamed: installMissing -> testRun
% in ec548f2, and to dryrun in 2026 at the user's direction.)
