...
% This was the version in +bfra. Not sure if this was the original version, but
% it had the explicit notes below so I copied it here before deleting from bfra
% since it was not used there. There might be a more complete version of the
% different tests I tried than whats below. 
