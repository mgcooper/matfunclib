...
%CONVERTTOINLINEPROGRAM convert function calls in function file to inline code
% 
% 
% 
% See also
...
if nargin < 4 || acceptRisk == false
   warning('CONVERTTOINLINEPROGRAM is experimental, set input argument 4 true to proceed')
   return
end
...
for i = 1:numel(mFiles)
   ...
   for j = 1:numel(startIndex)
      newFunctionLines = [newFunctionLines(1:startIndex(j)-1), functionFileLines, newFunctionLines(endIndex(j)+1:end)];
   end
end
