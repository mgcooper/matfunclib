function str = struct2nameval(opts)
   %STRUCT2NAMEVAL Collapse a name-value struct into comma and colon markup.
   %
   ...
   %  struct2nameval(s)
   %
   % See also: optionsToNamedArguments, struct2varargin, namedargs2cell
