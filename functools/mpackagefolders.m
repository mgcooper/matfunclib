...
% 
% LIST = mpackagefolders(FOLDERNAME) returns a directory structure in the same
% format as DIR containing all package folders and subpackage folders relative
% to top-level directory FOLDERNAME
%
