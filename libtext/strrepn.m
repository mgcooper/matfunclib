...
%STRREPN Performs multiple case-sensitive replacements of substrings within a string
%
%   OUT = STRREPN(STR, OLD1, NEW1, OLD2, NEW2, ...) replaces all occurrences of the
%   string OLD1 within the string STR with the string NEW1, then replaces OLD2 with
%   NEW2, and so on. The comparisons are case-sensitive. The function returns the
%   result as the output OUT.
%
%   Inputs:
...
%
%   Example:
%   strrepn('Hello World!', 'World', 'everyone', 'Hello', 'Goodbye') 
%   returns 'Goodbye everyone!'
%
%   Note: If STR, OLD or NEW are not provided, the function uses default values.
%
%   The function requires an even number of input arguments after STR, as they
%   should come in pairs of OLD and NEW.
%
