...
%
%   OUT = STRREPIN(STR, OLD1, NEW1, OLD2, NEW2, ...) replaces all occurrences of
%   the string OLD1 within the string STR with the string NEW1, then replaces
%   OLD2 with NEW2, and so on. The comparisons are case-insensitive. The
%   function returns the result as the output OUT.
%
%   Inputs:
