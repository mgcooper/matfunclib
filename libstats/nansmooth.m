function S = nansmooth(Y,w,type,tol)
   %NANSMOOTH Smooth data with nans
   %
   % nansmooth(Y,w,type,tol) smooths vector Y with moving
   ...
   switch type
      case 1
         S = sa(Y,w,tol);
      case 2
         S = sa(sa(Y,w,tol),w,tol);
      case 3
         S = sa(sa(sa(Y,w,tol),w,tol),w,tol);
   end
end
