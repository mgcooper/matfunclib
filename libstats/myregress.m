function [b,bint,r,rint,stats] = myregress(y,X,alpha)    
...
% mgc added standard error of slope and intercept as outputs
...
if nargout >= 2
    ...
    se = zeros(ncolX,1);           % mgc changed from se to bse
    ...
    if nargout == 5
        ...
        stats = [r2 F prob s2]; % mgc added bse
