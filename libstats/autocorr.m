...
%   
% [ lagcorr ] = autocorr( X, lag, dim ) returns the lagged auto-correlation of
% data in vector or matrix X. If X is a matrix, use DIM to control the dimension
% along which the correlation is computed.
% 
% See also
