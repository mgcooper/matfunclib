function [SE,CI,PM,mu,sig] = stderr(data,varargin)
   ...
   % error of the mean from the standard deviation of the data and the sample
   % size, and applies a critical t-value to compute 95% confidence intervals.
   %
   ...
   % assume data is oriented columnwise, and get the mean +/- stderr of each row
