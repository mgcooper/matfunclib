classdef testYorkfit < matlab.unittest.TestCase
   ...
   % least-squares short circuits, the zero rxy default for four inputs,
   ...
   properties (TestParameter)
      ...
      % identifier. Cases: X contains NaN, X and Y have different sizes, sigX
      % is not finite, sigY contains NaN, and rxy contains NaN.
      badinput = struct( ...
