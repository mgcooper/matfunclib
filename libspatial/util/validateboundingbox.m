...
%VALIDATEBOUNDINGBOX Function validation for 2x2 geographic bounding box array.
%
%  VALIDATEBOUNDINGBOX(BBOX, FUNCNAME, VARNAME, ARGPOS) validates the bounding
%  box array BBOX is a 2-by-2 array of double with real, finite values, and that
%  in each column the second value always exceeds the first.
