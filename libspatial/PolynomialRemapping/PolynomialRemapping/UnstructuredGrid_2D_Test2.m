...
nInterp=1.5; % nInterp is positive, Therefore, any point within 1.5 distance
             % of the destination point is going to be used. If there are
             % not enough points, the code would generate a warning and
...
P=ConstructPolyInterpolant2D(xs,ys,xd,yd,nPoly,nInterp);
...
for i=1:4
  subplot(2,2,i)
  plot(z_interp(:,i),'k.','MarkerSize',15);
  hold on
  plot(z_Analytic(:,i),'kx','MarkerSize',15);
