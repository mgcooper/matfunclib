...
%INTERPOLATIONPOINTS find xgrid/ygrid points inside poly and create query points
%
%  Points = interpolationPoints(poly,xgrid,ygrid,buffer,newRes) returns POINTS,
%  a structure containing coordinates in XGRID/YGRID found in POLY and new query
%  points XQ/YQ with horizontal resolution NEWRES resampled from the found
%  XGRID/YGRID points. Optional argument BUFFER extends the search space around
%  POLY.
%
% See also
