...
% % Otherwise, assume any format, first check if t is a datetime
%     if nargin == 9 % assume legacy format
%        % this used to be abve  
%     end

% need to overwrite this to let 
    if strcmp(varargin{1},'legacy')
        [si,ei] = findDateIndsLegacy(startdate,enddate,t);
    else
        [si,ei] = findDateInds(startdate,enddate,t);
    end

end

function [si,ei] = findDateInds(startdate,enddate,t)    
...
function [si,ei] = findDateIndsLegacy(startdate,enddate,t)
