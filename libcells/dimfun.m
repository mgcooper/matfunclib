function varargout = dimfun(fn, dim, varargin)
   ...
   % columns of matrices. I'm also using it in my slow m-file version of histc
   % for use in Octave. However, the nd-array stuff is a bit too hacky, and I'm
   % still getting my head around it. That's why this is private.
