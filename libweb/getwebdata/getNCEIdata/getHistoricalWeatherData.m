function [  Tmin,Tmax,Tmean,                                            ...
            seaLevelPressure,                                           ...
            stationPressure   ]  =  getHistoricalWeatherData(stationID,Date)
...
% mgc: added stationID to input, previous default was 47936099999
% kuparuk should be USC00505136, see various station lists here: 
% https://www.ncei.noaa.gov/access/homr/

WeatherData = getWeatherDataFromService(stationID,Date);
...
function WeatherData = getWeatherDataFromService(stationID,Date)
