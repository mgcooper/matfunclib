function cpinfoxml(dstpath)
   %CPINFOXML Copy info.xml and helptoc.xml to dstpath without overriding.
   %
   %  cpinfoxml(dstpath)
   %
   ...
   if isfile(dstname)
      warning( ...
         'info_template.xml exists in dstpath, copying with unique filename ID')
      tmpname = tempfile();
   ...
   if isfile(dstname)
      warning( ...
         'helptoc_template.xml exists in dstpath, copying with unique filename ID')
      tmpname = tempfile();
