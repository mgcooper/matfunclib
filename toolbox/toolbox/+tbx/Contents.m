% +TBX
% 
%   Contents file for +TBX and its subfolders.
%   
%   +TBX/+INTERNAL
%   tbx.internal.addcopyright               - ADD COPYRIGHT info to M-file
%   tbx.internal.appendToStartup            - Default formatted string if no template file is provided
...
%   tbx.internal.figfilepath                - Build full path to graphics file relative to project folder
...
%   tbx.internal.matfilepath                - Build full path to matfile relative to top level project folder
%   tbx.internal.privatefunction            - Return handle(s) to private functions in toolbox
%   tbx.internal.releaseoptions             - Build the packaging options a release uses
...
%   tbx.internal.version                    - Read version.txt in the project root directory
%   tbx.internal.writematlabbib             - Write matlab bibtex entry to file
%   
%   +TBX/+INTERNAL/PRIVATE
...
%    
%   This file was generated by updatecontents.m on 16 Aug 2026 at 21:42:44.
