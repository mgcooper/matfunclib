function data = readfiles_optional(filenameorlist,dataoutputtype,varargin)
...
%~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
   ...
   validfiles  = @(x)validateattributes(x,{'struct','char','string'},{'nonempty'},...
                     'readfiles','filenameorlist',1);
